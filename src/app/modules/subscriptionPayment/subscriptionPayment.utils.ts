...
//     const { _id, subcriptionId, subscriptionFor, subscriptionForType, amount, subcriptionTitle, duration } =
//       payload;
...
//       success_url: `http://10.10.10.32:8010/api/v1/subcription-payment-requests/confirm-payment?sessionId={CHECKOUT_SESSION_ID}&userId=${_id}&amount=${amount}&subcriptionId=${subcriptionId}&duration=${duration}&subscriptionFor=${subscriptionFor}&subscriptionForType=${subscriptionForType}`,

//       cancel_url: `http://10.10.10.32:8010/api/v1/payments/cancel?paymentId=${"paymentDummy"}`,
//       mode: "payment",
